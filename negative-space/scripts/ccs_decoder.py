...
scripts/build_universal_ccs.py.
...
# UNIVERSAL_CATALOG: 4 topic-agnostic caveats used by the universal-scratchpad
# experiment. Same 4 apply to every topic, so bit i is topic-independent.
UNIVERSAL_CATALOG = [
...
CATALOGS["universal"] = UNIVERSAL_CATALOG
